  ...
  return (
    <section className="pt-32 pb-16 md:pt-40 md:pb-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute -bottom-32 left-1/2 transform -translate-x-1/2 w-3/4 h-48 bg-violet-100/40 rounded-full blur-3xl"></div>
        ...
        ></motion.div>
        <motion.div 
          className="absolute bottom-32 right-1/6 w-14 h-14 border-2 border-violet-200 rounded-full"
          animate={{ 
            rotate: [0, 12, 0],
            opacity: [0.6, 0.9, 0.6]
          }}
      ...
      <div className="container mx-auto px-6 relative">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-br from-primary-600 via-violet-600 to-indigo-600">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-8">
              <Button 
                ...
                className="bg-gradient-to-br from-primary-500 via-violet-500 to-indigo-500 hover:shadow-lg hover:shadow-primary-500/20 text-white px-8 py-7 rounded-2xl text-lg shadow-md transition-all duration-300 transform hover:scale-[1.02]"
                size="lg"
              >
              ...
              <div className="flex items-center text-sm text-gray-500 mt-2 sm:mt-0 justify-center lg:justify-start">
                <div className="flex -space-x-3 mr-3">
                  <div className="w-9 h-9 rounded-full border-2 border-white bg-primary-100 flex items-center justify-center text-primary-600 overflow-hidden">
                    <Users size={14} />
                  </div>
                  ...
                  <div className="w-9 h-9 rounded-full border-2 border-white bg-violet-100 flex items-center justify-center text-violet-600 overflow-hidden">
                    <Twitter size={14} />
                  </div>
                </div>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-5 mb-8">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">Free starter plan</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-5 h-5 rounded-full bg-primary-50 flex items-center justify-center">
                  <Check className="w-3 h-3 text-primary-500" />
          ...
          >
            <div className="rounded-2xl overflow-hidden backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl">
              <div className="flex items-center justify-between bg-gray-50/90 p-3 border-b border-gray-100/80">
                ...
                <div className="text-xs font-medium text-gray-500">Content Generator</div>
              ...
              <div className="p-6">
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-lg text-gray-900">Create new content</h3>
                    <div className="flex items-center gap-2">
                      <Twitter className="w-4 h-4 text-primary-500" />
                      <span className="text-xs font-medium bg-primary-50 text-primary-600 py-1 px-2 rounded-full">Live</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-50/70 rounded-xl p-5 border border-gray-100/50">
                      <div className="flex items-start mb-3">
                        ...
                        <div className="flex-1">
                          <p className="font-bold text-gray-900">Content Creator</p>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button className="bg-gray-50/70 hover:bg-gray-100 rounded-xl p-3 transition-all text-sm font-medium text-gray-700 border border-gray-100/50">
                        Regenerate
                      </button>
                      <button className="bg-primary-50/70 hover:bg-primary-100 rounded-xl p-3 transition-all text-sm font-medium text-primary-700 border border-primary-100/50">
                        Save to drafts
                      </button>
                    </div>
                  ...
                  <div className="h-32 relative">
                    <div className="absolute inset-0 flex items-end">
                      {Array.from({ length: 7 }).map((_, i) => (
                        ...
                        >
                          <div 
                            className="rounded-t bg-gradient-to-b from-primary-400/70 to-violet-500/70 w-full h-full"
                          ></div>
                        </motion.div>
                      ))}
                    </div>
