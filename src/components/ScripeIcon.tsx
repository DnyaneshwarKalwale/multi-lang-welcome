...
// New logo: "Prism"
export function PrismLogotype({ className = "h-10", ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="180"
      height="48"
    ...
    >
      <path
        d="M60.256 34V15.2H66.848C68.992 15.2 70.72 15.616 72.032 16.448C73.344 17.28 74.304 18.416 74.912 19.856C75.52 21.296 75.824 22.928 75.824 24.752C75.824 26.576 75.52 28.192 74.912 29.6C74.304 31.008 73.344 32.112 72.032 32.912C70.72 33.712 68.992 34.112 66.848 34.112H60.256V34ZM65.104 30.288H66.56C67.584 30.288 68.448 30.096 69.152 29.712C69.856 29.328 70.368 28.72 70.688 27.888C71.008 27.056 71.168 25.984 71.168 24.672C71.168 23.36 71.008 22.272 70.688 21.408C70.368 20.544 69.856 19.92 69.152 19.536C68.448 19.152 67.584 18.96 66.56 18.96H65.104V30.288Z"
        className="fill-primary-500 dark:fill-primary-400"
      />
      <path
        d="M77.664 34V15.2H89.84V18.96H82.512V22.848H88.816V26.608H82.512V30.24H89.84V34H77.664Z"
        className="fill-current text-gray-800 dark:text-gray-200"
      />
      <path
        d="M92.148 34V15.2H96.996V34H92.148ZM100.676 34L95.828 24.8L100.676 15.2H105.716L100.676 24.656V24.8L106.02 34H100.676Z"
        className="fill-current text-gray-800 dark:text-gray-200"
      />
      <path
        d="M113.24 34.352C111.768 34.352 110.488 34.048 109.4 33.44C108.312 32.832 107.464 31.984 106.856 30.896C106.248 29.808 105.944 28.544 105.944 27.104V22.096C105.944 20.656 106.248 19.392 106.856 18.304C107.464 17.216 108.312 16.368 109.4 15.76C110.488 15.152 111.768 14.848 113.24 14.848C115.16 14.848 116.728 15.328 117.944 16.288C119.16 17.248 119.928 18.576 120.248 20.272H115.352C115.224 19.728 114.952 19.296 114.536 18.976C114.12 18.656 113.624 18.496 113.048 18.496C112.376 18.496 111.832 18.72 111.416 19.168C111 19.616 110.792 20.224 110.792 20.992V28.208C110.792 28.976 111 29.584 111.416 30.032C111.832 30.48 112.376 30.704 113.048 30.704C113.624 30.704 114.12 30.544 114.536 30.224C114.952 29.904 115.224 29.472 115.352 28.928H120.248C119.928 30.624 119.16 31.952 117.944 32.912C116.728 33.872 115.16 34.352 113.24 34.352Z"
        className="fill-current text-gray-800 dark:text-gray-200"
      />
      <path
        d="M121.879 34V15.2H126.727V34H121.879Z"
        className="fill-current text-gray-800 dark:text-gray-200"
      />
      <path
        d="M135.326 34.352C133.886 34.352 132.622 34.064 131.534 33.488C130.446 32.912 129.598 32.08 128.99 30.992C128.382 29.904 128.078 28.608 128.078 27.104V22.096C128.078 20.592 128.39 19.296 129.014 18.208C129.638 17.12 130.494 16.288 131.582 15.712C132.67 15.136 133.91 14.848 135.302 14.848C136.694 14.848 137.934 15.136 139.022 15.712C140.11 16.288 140.966 17.12 141.59 18.208C142.214 19.296 142.526 20.592 142.526 22.096V27.104C142.526 28.608 142.214 29.904 141.59 30.992C140.966 32.08 140.11 32.912 139.022 33.488C137.934 34.064 136.686 34.352 135.326 34.352ZM135.326 30.704C136.046 30.704 136.622 30.48 137.054 30.032C137.486 29.584 137.702 28.976 137.702 28.208V20.992C137.702 20.224 137.486 19.616 137.054 19.168C136.622 18.72 136.046 18.496 135.326 18.496C134.606 18.496 134.03 18.72 133.598 19.168C133.166 19.616 132.95 20.224 132.95 20.992V28.208C132.95 28.976 133.166 29.584 133.598 30.032C134.03 30.48 134.606 30.704 135.326 30.704Z"
        className="fill-current text-gray-800 dark:text-gray-200"
      />
      <path
        d="M146.016 34V15.2H151.152L155.952 26.8H156.144V15.2H160.944V34H155.808L151.008 22.4H150.816V34H146.016Z"
        className="fill-current text-gray-800 dark:text-gray-200"
      />
      <path
...
export function PrismIcon({ className = "h-8 w-8", ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="40"
      height="40"
...
export function PrismIconRounded({ className = "h-10 w-10", ...props }: React.SVGProps<SVGSVGElement>) {
  return (
...
// Keep the original exports but redirect to the new components
export const ScripeLogotype = PrismLogotype;
