...
export const ScripeLogotype = SekcionLogotype;
export const ScripeIcon = SekcionIcon;
export const ScripeIconRounded = SekcionIconRounded;
export const PrismLogotype = SekcionLogotype;
export const PrismIcon = SekcionIcon;
export const PrismIconRounded = SekcionIconRounded;
