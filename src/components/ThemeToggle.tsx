...
export default function ThemeToggle() {
  ...
  if (!mounted || !isThemeLoaded) {
    return (
      <button 
        className="w-10 h-10 rounded-md bg-gray-100 dark:bg-gray-800 opacity-50 flex items-center justify-center"
        disabled
  ...
  return (
    <button
      ...
      className="w-10 h-10 rounded-md bg-white/10 dark:bg-gray-800/40 backdrop-blur-sm border border-gray-200/20 dark:border-gray-700/40 
                hover:bg-primary-100/20 dark:hover:bg-primary-900/20 hover:text-primary-600 dark:hover:text-primary-400 
