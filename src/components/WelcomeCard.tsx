  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <p className="text-black mb-6 flex-grow italic font-medium text-base">&ldquo;{quote}&rdquo;</p>
        
        <div className="flex items-center mt-auto">
          <img 
            src={avatarUrl} 
            alt={author} 
            className="w-12 h-12 rounded-full mr-3 object-cover ring-2 ring-black"
          />
          <div>
            <div className="font-bold text-black">{author}</div>
            <div className="text-sm text-black font-medium">{role}</div>
          </div>
        </div>
      </div>
    </motion.div>
