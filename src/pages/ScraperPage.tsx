    ...
    try {
      ...
      try {
        ...
        try {
          ...
          if (baseUrl.endsWith('/api')) {
            fallbackUrl = `${baseUrl}/transcript/fallback?id=${videoId}`;
          } else {
            fallbackUrl = `${baseUrl}/api/transcript/fallback?id=${videoId}`;
          }
          
          const fallbackResponse = await axios.get(fallbackUrl);
          
          if (fallbackResponse.data && fallbackResponse.data.success) {
            transcriptText = fallbackResponse.data.transcript;
            toast.success('Fetched transcript from fallback service');
          } else {
      ...
      if (transcriptText) {
        ...
        throw new Error('No transcript content received from any source');
      }
    } catch (error: any) {
