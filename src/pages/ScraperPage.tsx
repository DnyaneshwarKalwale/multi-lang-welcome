...
const ScraperPage: React.FC = (): JSX.Element => {
  ...
  // Handler for post selection in the modal
  const handlePostSelectionApply = (content: string, counts: { twitter: number; linkedin: number }) => {
    // Handle the selected posts content
    console.log('Selected posts content:', content);
    console.log('Selection counts:', counts);
    setSavedPostsModalOpen(false);
  };
  ...
  // Removed SavedPostsModal - now using reusable PostSelectionModal component
