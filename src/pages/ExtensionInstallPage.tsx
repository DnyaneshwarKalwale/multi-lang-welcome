    ...
    <div className="min-h-screen bg-brand-gray-900 text-white">
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">{t('easyContentCreation')}</h3>
              </div>
              <p className="text-brand-gray-300">{t('easyContentCreationDescription')}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-brand-gray-300">{t('quickAccessDescription')}</p>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">{t('multiLanguageSupport')}</h3>
              </div>
              <p className="text-brand-gray-300">{t('multiLanguageSupportDescription')}</p>
            </motion.div>
          ...
          >
            {isInstalled ? (
              <div className="flex items-center justify-center space-x-2 text-brand-success">
                <CheckCircle2 className="w-5 h-5" />
                <span>{t('extensionInstalled')}</span>
              </div>
            ) : (
              <div className="flex items-center justify-center space-x-2 text-brand-gray-400">
                <XCircle className="w-5 h-5" />
                <span>{t('extensionNotInstalled')}</span>
              </div>
            )}
          </motion.div>
          ...
          >
            ...
            >
              {isChecking ? t('checkingInstallation') : t('checkInstallation')}
            </Button>
            <Button
