...
const translations: Record<Language, Record<string, string>> = {
  english: {
    ...
    profileReady: "Your profile is ready! Let's make your content creation experience exceptional with Sekcion.",
    chooseNextStep: "Choose your next step",
    createFirstContent: "Create first content",
    aiContentDescription: "Our AI will craft personalized content based on your preferences and style",
    contentGenerated: "Content successfully generated! You can view it in your dashboard.",
    generating: "Generating...",
    generateContent: "Generate content",
    connectTwitterAccount: "Connect Twitter account",
    twitterLinkDescription: "Link your Twitter to publish content with a single click",
    twitterConnected: "Twitter account successfully connected! You can manage it in your dashboard.",
  ...
  german: {
    ...
    profileReady: "Ihr Profil ist bereit! Lassen Sie uns mit Sekcion Ihr Content-Erlebnis außergewöhnlich gestalten.",
    chooseNextStep: "Wählen Sie Ihren nächsten Schritt",
    createFirstContent: "Ersten Inhalt erstellen",
    aiContentDescription: "Unsere KI erstellt personalisierte Inhalte basierend auf Ihren Präferenzen und Ihrem Stil",
    contentGenerated: "Inhalt erfolgreich generiert! Sie können ihn in Ihrem Dashboard anzeigen.",
    generating: "Generiere...",
    generateContent: "Inhalt generieren",
    connectTwitterAccount: "Twitter-Konto verbinden",
    twitterLinkDescription: "Verknüpfen Sie Ihren Twitter-Account, um Inhalte mit einem Klick zu veröffentlichen",
    twitterConnected: "Twitter-Konto erfolgreich verbunden! Sie können es in Ihrem Dashboard verwalten.",
    connecting: "Verbinde...",
    errorOccurred: "Ein Fehler ist aufgetreten",
    retry: "Wiederholen",
    savingPreferences: "Einstellungen werden gespeichert...",
  ...
  spanish: {
    ...
    profileReady: "¡Su perfil está listo! Hagamos que su experiencia de creación de contenido sea excepcional con Sekcion.",
    chooseNextStep: "Elija su próximo paso",
    createFirstContent: "Crear primer contenido",
    aiContentDescription: "Nuestra IA creará contenido personalizado basado en sus preferencias y estilo",
    contentGenerated: "¡Contenido generado con éxito! Puede verlo en su panel de control.",
    generating: "Generando...",
    generateContent: "Generar contenido",
    connectTwitterAccount: "Conectar cuenta de Twitter",
    twitterLinkDescription: "Vincule su Twitter para publicar contenido con un solo clic",
    twitterConnected: "¡Cuenta de Twitter conectada con éxito! Puede administrarla en su panel de control.",
  ...
  french: {
    ...
    profileReady: "Votre profil est prêt ! Rendons votre expérience de création de contenu exceptionnelle avec Sekcion.",
    chooseNextStep: "Choisissez votre prochaine étape",
    createFirstContent: "Créer premier contenu",
    aiContentDescription: "Notre IA créera du contenu personnalisé basé sur vos préférences et votre style",
    contentGenerated: "Contenu généré avec succès ! Vous pouvez le consulter dans votre tableau de bord.",
    generating: "Génération en cours...",
    generateContent: "Générer du contenu",
    connectTwitterAccount: "Connecter un compte Twitter",
    twitterLinkDescription: "Liez votre Twitter pour publier du contenu en un seul clic",
    twitterConnected: "Compte Twitter connecté avec succès ! Vous pouvez le gérer dans votre tableau de bord.",
